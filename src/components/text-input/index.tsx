...
export default function TextInputComponent(props: InputProps, ref: any) {
  ...
  return (
    <Block style={containerStyle}>
      ...
      >
        {leftIcon && (
          <Block position="absolute" left={10} width={20} zIndex="full">
            {renderIcon()}
          </Block>
        )}
        {renderInput()}
